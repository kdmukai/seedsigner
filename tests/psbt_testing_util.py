...
class PSBTTestData:
    ...
    # Specialty data; spending key's fingerprint is 00000000
    fingerprint_00000000_seed = Seed("caught siege debate lab loan digital front absurd stone pull evolve rebuild".split())
    FINGERPRINT_00000000_SINGLE_SIG_NATIVE_SEGWIT = ""
    FINGERPRINT_00000000_SINGLE_SIG_TAPROOT = ""
    ALL_FINGERPRINT_00000000_PSBTS = [
        FINGERPRINT_00000000_SINGLE_SIG_NATIVE_SEGWIT,
        FINGERPRINT_00000000_SINGLE_SIG_TAPROOT,
    ]
