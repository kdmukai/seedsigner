...
def generate_screenshots(locale):
    ...
    def setup_screenshots(locale: str) -> dict[str, list[ScreenshotConfig]]:
        ...
        def coinjoin_pays_fee_cb_before():
            malcolm_seed = Seed("better gown govern speak spawn vendor exercise item uncle odor sound cat".split())
            # Straightforward coinjoin (from TestPSBTParserCooperativeSpend.test_coinjoin_remix)
            malcolm_coinjoin_psbt_base64 = ""
            controller.psbt_seed = malcolm_seed
            decoder = DecodeQR()
        ...
        def coinjoin_free_remix_cb_before():
            zoe_seed = Seed("sign sword lift deer ocean insect web lazy sick pencil start select".split())
            # Straightforward coinjoin (from TestPSBTParserCooperativeSpend.test_coinjoin_remix)
            zoe_coinjoin_psbt_base64 = ""
            controller.psbt_seed = zoe_seed
            decoder = DecodeQR()
            decoder.add_data(zoe_coinjoin_psbt_base64)
            controller.psbt = decoder.get_psbt()
            controller.psbt_parser = PSBTParser(p=controller.psbt, seed=zoe_seed, network=SettingsConstants.MAINNET)


        def coinjoin_joint_fee_malcolm_cb_before():
            malcolm_seed = Seed("better gown govern speak spawn vendor exercise item uncle odor sound cat".split())
            # Coinjoin where both parties are contributing to a fee (from TestPSBTParserCooperativeSpend.test_coinjoin_remix)
            malcolm_coinjoin_psbt_base64 = ""
            controller.psbt_seed = malcolm_seed
            decoder = DecodeQR()
            decoder.add_data(malcolm_coinjoin_psbt_base64)
            controller.psbt = decoder.get_psbt()
        ...
        def coinjoin_joint_fee_zoe_cb_before():
            zoe_seed = Seed("sign sword lift deer ocean insect web lazy sick pencil start select".split())
            # Coinjoin where both parties are contributing to a fee (from TestPSBTParserCooperativeSpend.test_coinjoin_remix)
            zoe_coinjoin_psbt_base64 = ""
            controller.psbt_seed = zoe_seed
            decoder = DecodeQR()
            decoder.add_data(zoe_coinjoin_psbt_base64)
            controller.psbt = decoder.get_psbt()
        ...
        screenshot_sections = {
            ...
            "PSBT Views": [
                ...
                # Coinjoin
                ScreenshotConfig(psbt_views.PSBTOverviewView, screenshot_name="PSBTOverviewView_coinjoin_pays_fee", run_before=coinjoin_pays_fee_cb_before),
                ScreenshotConfig(psbt_views.PSBTMathView, screenshot_name="PSBTMathView_coinjoin_pays_fee"),  # Relies on callback above
                ScreenshotConfig(psbt_views.PSBTOverviewView, screenshot_name="PSBTOverviewView_coinjoin_free_remix", run_before=coinjoin_free_remix_cb_before),
                ScreenshotConfig(psbt_views.PSBTMathView, screenshot_name="PSBTMathView_coinjoin_free_remix"),  # Relies on callback above

                ScreenshotConfig(psbt_views.PSBTOverviewView, screenshot_name="PSBTOverviewView_coinjoin_joint_fee_malcolm", run_before=coinjoin_joint_fee_malcolm_cb_before),
                ScreenshotConfig(psbt_views.PSBTMathView, screenshot_name="PSBTMathView_coinjoin_joint_fee_malcolm"),  # Relies on callback above
                ScreenshotConfig(psbt_views.PSBTOverviewView, screenshot_name="PSBTOverviewView_coinjoin_joint_fee_zoe", run_before=coinjoin_joint_fee_zoe_cb_before),
                ScreenshotConfig(psbt_views.PSBTMathView, screenshot_name="PSBTMathView_coinjoin_joint_fee_zoe"),  # Relies on callback above
            ],
            "Tools Views": [
